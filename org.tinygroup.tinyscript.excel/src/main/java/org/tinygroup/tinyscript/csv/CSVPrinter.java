...
import static org.tinygroup.tinyscript.csv.Constants.COMMENT;
import static org.tinygroup.tinyscript.csv.Constants.CR;
import static org.tinygroup.tinyscript.csv.Constants.LF;
import static org.tinygroup.tinyscript.csv.Constants.SP;
...
public final class CSVPrinter implements Flushable, Closeable {
    ...
    public void printRecords(final DataSet dataSet) throws Exception {
    	int columnCount = dataSet.getColumns();
        while (dataSet.next()) {
            for (int i = 0; i < columnCount; i++) {
                print(dataSet.getData(i));
            }
            println();
        }
    }
