 ...
 *
 */
public class SubtractOperator extends ExtendTwoOperator{
	...
	protected Object operation(Object left, Object right) {
		if(isType(left, List.class) && isType(right, List.class)){
		    return subtract((List)left,(List)right);
		}else if(isType(left, Set.class) && isType(right, Set.class)){
			return subtract((Set)left,(Set)right);
		}else if(isType(left, Map.class) && isType(right, Map.class)){
			return subtract((Map)left,(Map)right);
		}
		return null;
	}

	@SuppressWarnings({ "unchecked", "rawtypes" })
	protected List subtract(List t1, List t2) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	protected Set subtract(Set t1, Set t2) {
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	protected Map subtract(Map t1, Map t2) {
