...
public class CombinationFunction extends AbstractScriptFunction {
	...
	protected ScriptResult getCombinations(Object[] source, LambdaFunction function, ScriptContext context, int len)
			throws Exception {
	...
	protected ScriptResult getCombinations(Object[] source, LambdaFunction function, ScriptContext context)
			throws Exception {
		List<Object> temp = new ArrayList<Object>();
